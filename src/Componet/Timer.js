...
class Timer extends React.Component {
    constructor(props) {
        ...
        setInterval(() => { if (this.state.status !== 'stop') 
        ...
        return (
            ...
            <div className='element'>
                <div className="time">
                    ...
                    <button className='btn' onClick={this.startwatch}>{this.state.status === 'stop' ? 'start' : 'pause'}</button>
                    <button className='btn' onClick={this.stopwatch}>Reset</button>
